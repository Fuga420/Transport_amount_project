...
\begin{center}
  \begin{minipage}{150mm}
      \centering
      {\gtfamily\bfseries\fontsize{20bp}{24bp}\selectfont \jtitle\par}
      \vspace{15mm}
      {\fontsize{12bp}{15bp}\selectfont \jauthors\par}
      \vspace{5mm}
      {\fontsize{9bp}{12bp}\selectfont \jaffiliations\par}
      \vspace{10mm}
      \raggedright
...
\begin{minipage}{150mm}
\centering
{\bfseries\fontsize{12bp}{15bp}\selectfont
STRUCTURAL CHANGE DECOMPOSITION OF A LINKED JAPANESE PARCEL-VOLUME SERIES\par}
\vspace{\baselineskip}
{\fontsize{12bp}{15bp}\selectfont Author A and Author B\par}
\vspace{\baselineskip}
\raggedright
