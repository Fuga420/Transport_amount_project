...
\author{
  寺嶋風雅%
  \affil{中央大学大学院 理工学研究科 〒112-8551 東京都文京区春日1-13-27 email: a21.gn8t@g.chuo-u.ac.jp}
  \and
  赤悠悟羽根%
  \affil{中央大学理工学部}
  \and
...
国内のEC市場においても, 状態空間モデルを用いた大規模なセール効果の分析が行われるなど (富山 他, 2024), データに基づく市場動向の把握が進んでいる.
...
STL分解は, その汎用性の高さと外れ値に対する頑健性から, 
時系列データの季節調整やトレンド抽出を行う際の標準的な手法として広く利用されている. 
特に, データの全体的な構造を視覚的かつ直感的に把握する上では, 極めて手軽で強力なツールである. 
...
これが外部イベントの影響評価における保守的かつ信頼性の高い結果につながったと解釈できる.(Durbin \& Koopman, 2012)
...
近年ではRamos et al. (2024)が提唱する「State Space Learning: SSL」という
